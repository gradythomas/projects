...
export default function Nugs(props) {
    ...
    useEffect(() => {
        props.setScrollFunctions({
            ...
            descriptionScroll: (e) => window.scrollTo(0, descriptionRef.current.offsetTop - 60), 
            analysisScroll: (e) => window.scrollTo(0, analysisRef.current.offsetTop - 60), 
    ...
    return (
        ...
        <BasicBlock header={descriptionText[0]} paragraph={descriptionText[1]} />
        <div ref={analysisRef} />
        <BasicBlock header={analysisText[0]} paragraph={analysisText[1]} />
        <div ref={demoRef} />
